...
class PolzaClient:
    def __init__(self) -> None:
        ...
        async def list_models(self) -> list[dict[str, str]]:
            response = await self._response("GET", "/models")
            models = []
        ...
        async def complete(self, model_id: str, messages: list[dict[str, str]]) -> str:
            ...
            try:
                ...
                raise PolzaError("Polza.ai вернул отввет неизвестного формата") from exc
        ...
        @staticmethod
        def _jsom(response: httpx.Response) -> dict[str, Any]:
            try:
